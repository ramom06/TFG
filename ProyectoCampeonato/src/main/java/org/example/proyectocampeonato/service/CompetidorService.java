...
public class CompetidorService {
    ...
    public CompetidorService(CompetidorRepository competidorRepository, UsuarioRepository usuarioRepository, PasswordEncoder passwordEncoder) {
    ...
    public void delete(Long id) {
        if (!competidorRepository.existsById(id)) throw new CompetidorNotFoundException(id);
