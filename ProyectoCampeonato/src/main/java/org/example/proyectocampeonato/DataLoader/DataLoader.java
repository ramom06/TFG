...
// CAMPEONATOS - usando toDate() para convertir LocalDate a Date correctamente
        ...
        Competidor senM3  = Competidor.builder().nombre("Carlos").apellidos("López Martín").dni("11223344C").email("carlos.lopez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 3, 15))).genero('M').club("Karate Aragón").federacionAutonomica("Aragón").build();
        Competidor senM4  = Competidor.builder().nombre("Sergio").apellidos("Fernández Ruiz").dni("55667788G").email("sergio.fernandez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1997, 4, 30))).genero('M').club("Karate Santander").federacionAutonomica("Cantabria").build();
        Competidor senM5  = Competidor.builder().nombre("Miguel").apellidos("Rodríguez Blanco").dni("77889900I").email("miguel.rodriguez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1996, 12, 5))).genero('M').club("Karate Valladolid").federacionAutonomica("Castilla y León").build();
        Competidor senM6  = Competidor.builder().nombre("Javier").apellidos("Moreno Castillo").dni("99001122K").email("javier.moreno@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 2, 14))).genero('M').club("Karate Mérida").federacionAutonomica("Extremadura").build();
        Competidor senM7  = Competidor.builder().nombre("David").apellidos("Romero Iglesias").dni("10203040M").email("david.romero@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1998, 5, 3))).genero('M').club("Karate Logroño").federacionAutonomica("La Rioja").build();
        Competidor senM8  = Competidor.builder().nombre("Pablo").apellidos("Torres Herrera").dni("30405060O").email("pablo.torres@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 10, 16))).genero('M').club("Karate Murcia").federacionAutonomica("Región de Murcia").build();
        Competidor senM9  = Competidor.builder().nombre("Iñaki").apellidos("Etxebarria Zubieta").dni("50607080Q").email("inaki.etxebarria@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 6, 11))).genero('M').club("Karate Bilbao").federacionAutonomica("País Vasco").build();
        Competidor senM10 = Competidor.builder().nombre("Alejandro").apellidos("Vega Santana").dni("70809000S").email("alejandro.vega@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2003, 4, 19))).genero('M').club("Karate Melilla").federacionAutonomica("Ciudad Autónoma de Melilla").build();
        Competidor senM11 = Competidor.builder().nombre("Fernando").apellidos("Castillo Reyes").dni("11122233T").email("fernando.castillo@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1995, 8, 7))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor senM12 = Competidor.builder().nombre("Raúl").apellidos("Molina Pardo").dni("22233344U").email("raul.molina@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 1, 25))).genero('M').club("Karate Pamplona").federacionAutonomica("Comunidad Foral de Navarra").build();
        Competidor senM13 = Competidor.builder().nombre("Óscar").apellidos("Blanco Fuentes").dni("33344455V").email("oscar.blanco@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2002, 7, 13))).genero('M').club("Karate Toledo").federacionAutonomica("Castilla-La Mancha").build();
        Competidor senM14 = Competidor.builder().nombre("Marcos").apellidos("Herrera Gutiérrez").dni("44455566W").email("marcos.herrera@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1997, 3, 28))).genero('M').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor senM15 = Competidor.builder().nombre("Antonio").apellidos("Soto Medina").dni("55566677X").email("antonio.soto@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 11, 9))).genero('M').club("Karate Santiago").federacionAutonomica("Galicia").build();
        Competidor senM16 = Competidor.builder().nombre("Diego").apellidos("Cruz Navarro").dni("66677788Y").email("diego.cruz@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1994, 6, 15))).genero('M').club("Karate Oviedo").federacionAutonomica("Principado de Asturias").build();
        Competidor senM17 = Competidor.builder().nombre("Rubén").apellidos("Vidal Campos").dni("77788899Z").email("ruben.vidal@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 9, 3))).genero('M').club("Karate Palma").federacionAutonomica("Islas Baleares").build();
        Competidor senM18 = Competidor.builder().nombre("Adrián").apellidos("Aguilar Delgado").dni("88899900A").email("adrian.aguilar@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1998, 4, 22))).genero('M').club("Karate Las Palmas").federacionAutonomica("Canarias").build();
        Competidor senM19 = Competidor.builder().nombre("Álvaro").apellidos("Marín Expósito").dni("99900011B").email("alvaro.marin@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2003, 12, 1))).genero('M').club("Karate Ceuta").federacionAutonomica("Ciudad Autónoma de Ceuta").build();
        Competidor senM20 = Competidor.builder().nombre("Gonzalo").apellidos("Pascual Llorente").dni("00011122C").email("gonzalo.pascual@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1996, 7, 18))).genero('M').club("Dojo Shoto Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor senM21 = Competidor.builder().nombre("Nicolás").apellidos("Serrano Bravo").dni("11100200D").email("nicolas.serrano@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 2, 14))).genero('M').club("Karate Sevilla").federacionAutonomica("Andalucía").build();
        Competidor senM22 = Competidor.builder().nombre("Hugo").apellidos("Ramos Ibáñez").dni("22200300E").email("hugo.ramos@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 8, 30))).genero('M').club("Karate Zaragoza").federacionAutonomica("Aragón").build();
        Competidor senM23 = Competidor.builder().nombre("Víctor").apellidos("Pons Leal").dni("33300400F").email("victor.pons@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2002, 5, 11))).genero('M').club("Karate Alicante").federacionAutonomica("Comunitat Valenciana").build();
        Competidor senM24 = Competidor.builder().nombre("Eduardo").apellidos("Fuentes Cortés").dni("44400500G").email("eduardo.fuentes@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1995, 10, 27))).genero('M').club("Karate Vigo").federacionAutonomica("Galicia").build();

        Competidor senF1  = Competidor.builder().nombre("María").apellidos("García Fernández").dni("22334455D").email("maria.garcia@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 7, 8))).genero('F').club("Karate Oviedo").federacionAutonomica("Principado de Asturias").build();
        Competidor senF2  = Competidor.builder().nombre("Laura").apellidos("González Díaz").dni("44556677F").email("laura.gonzalez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 9, 12))).genero('F').club("Karate Las Palmas").federacionAutonomica("Canarias").build();
        Competidor senF3  = Competidor.builder().nombre("Ana").apellidos("Sánchez Torres").dni("66778899H").email("ana.sanchez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2003, 6, 18))).genero('F').club("Karate Toledo").federacionAutonomica("Castilla-La Mancha").build();
        Competidor senF4  = Competidor.builder().nombre("Elena").apellidos("Jiménez Moreno").dni("88990011J").email("elena.jimenez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 8, 22))).genero('F').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor senF5  = Competidor.builder().nombre("Sofía").apellidos("Álvarez Prieto").dni("00112233L").email("sofia.alvarez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2002, 11, 9))).genero('F').club("Karate Santiago").federacionAutonomica("Galicia").build();
        Competidor senF6  = Competidor.builder().nombre("Lucía").apellidos("Serrano Molina").dni("20304050N").email("lucia.serrano@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 7, 27))).genero('F').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor senF7  = Competidor.builder().nombre("Claudia").apellidos("Ramírez Ortega").dni("40506070P").email("claudia.ramirez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1997, 3, 21))).genero('F').club("Karate Pamplona").federacionAutonomica("Comunidad Foral de Navarra").build();
        Competidor senF8  = Competidor.builder().nombre("Nuria").apellidos("Campos Benítez").dni("60708090R").email("nuria.campos@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 1, 7))).genero('F').club("Karate Ceuta").federacionAutonomica("Ciudad Autónoma de Ceuta").build();
        Competidor senF9  = Competidor.builder().nombre("Patricia").apellidos("Ortiz Guerrero").dni("11200300A").email("patricia.ortiz@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1998, 4, 15))).genero('F').club("Karate Bilbao").federacionAutonomica("País Vasco").build();
        Competidor senF10 = Competidor.builder().nombre("Marta").apellidos("León Carrasco").dni("22300400B").email("marta.leon@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 12, 3))).genero('F').club("Karate Murcia").federacionAutonomica("Región de Murcia").build();
        Competidor senF11 = Competidor.builder().nombre("Cristina").apellidos("Vargas Escribano").dni("33400500C").email("cristina.vargas@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 3, 19))).genero('F').club("Karate Logroño").federacionAutonomica("La Rioja").build();
        Competidor senF12 = Competidor.builder().nombre("Isabel").apellidos("Mora Cabrera").dni("44500600D").email("isabel.mora@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1996, 9, 8))).genero('F').club("Karate Santander").federacionAutonomica("Cantabria").build();
        Competidor senF13 = Competidor.builder().nombre("Rebeca").apellidos("Pardo Montoya").dni("55600700E").email("rebeca.pardo@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2002, 6, 25))).genero('F').club("Karate Extremadura").federacionAutonomica("Extremadura").build();
        Competidor senF14 = Competidor.builder().nombre("Verónica").apellidos("Cano Iglesias").dni("66700800F").email("veronica.cano@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 11, 14))).genero('F').club("Karate Valladolid").federacionAutonomica("Castilla y León").build();
        Competidor senF15 = Competidor.builder().nombre("Beatriz").apellidos("Prieto Alonso").dni("77800900G").email("beatriz.prieto@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2003, 2, 7))).genero('F').club("Karate Aragón").federacionAutonomica("Aragón").build();
        ...
        Competidor cadM3 = Competidor.builder().nombre("Daniel").apellidos("Castro Morales").dni("11111103C").email("daniel.castro@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2011, 11, 5))).genero('M').club("Karate Zaragoza").federacionAutonomica("Aragón").build();
        Competidor cadM4 = Competidor.builder().nombre("Lucas").apellidos("Jiménez Roca").dni("11111104D").email("lucas.jimenez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 4, 18))).genero('M').club("Karate Bilbao").federacionAutonomica("País Vasco").build();
        Competidor cadM5 = Competidor.builder().nombre("Martín").apellidos("Ortega Sanz").dni("11111105E").email("martin.ortega@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 1, 30))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor cadM6 = Competidor.builder().nombre("Tomás").apellidos("Fuentes Moya").dni("11111106F").email("tomas.fuentes@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2011, 8, 14))).genero('M').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor cadM7 = Competidor.builder().nombre("Ignacio").apellidos("Blanco Rueda").dni("11111107G").email("ignacio.blanco@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 12, 3))).genero('M').club("Karate Murcia").federacionAutonomica("Región de Murcia").build();
        Competidor cadM8 = Competidor.builder().nombre("Rodrigo").apellidos("Alonso Vera").dni("11111108H").email("rodrigo.alonso@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 5, 27))).genero('M').club("Karate Valladolid").federacionAutonomica("Castilla y León").build();

        Competidor cadF1 = Competidor.builder().nombre("Carla").apellidos("Navarro Soler").dni("22222201A").email("carla.navarro@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2011, 2, 15))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor cadF2 = Competidor.builder().nombre("Andrea").apellidos("Molina Ibáñez").dni("22222202B").email("andrea.molina@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 6, 9))).genero('F').club("Karate Granada").federacionAutonomica("Andalucía").build();
        Competidor cadF3 = Competidor.builder().nombre("Paula").apellidos("Herrero Cid").dni("22222203C").email("paula.herrero@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 10, 21))).genero('F').club("Karate Pamplona").federacionAutonomica("Comunidad Foral de Navarra").build();
        ...
        Competidor junM3 = Competidor.builder().nombre("Unai").apellidos("Arrizabalaga Olaiz").dni("33333303C").email("unai.arrizabalaga@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 3, 8))).genero('M').club("Karate Bilbao").federacionAutonomica("País Vasco").build();
        Competidor junM4 = Competidor.builder().nombre("Joel").apellidos("Giménez Puig").dni("33333304D").email("joel.gimenez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 1, 14))).genero('M').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor junM5 = Competidor.builder().nombre("Pol").apellidos("Soler Massana").dni("33333305E").email("pol.soler@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 7, 30))).genero('M').club("Karate Lleida").federacionAutonomica("Cataluña").build();
        Competidor junM6 = Competidor.builder().nombre("Enrique").apellidos("Pascual Delgado").dni("33333306F").email("enrique.pascual@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2008, 9, 19))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor junM7 = Competidor.builder().nombre("Borja").apellidos("Cabrera Núñez").dni("33333307G").email("borja.cabrera@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 4, 3))).genero('M').club("Karate Tenerife").federacionAutonomica("Canarias").build();
        Competidor junM8 = Competidor.builder().nombre("Jonás").apellidos("Ferrer Llorens").dni("33333308H").email("jonas.ferrer@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 12, 11))).genero('M').club("Karate Alicante").federacionAutonomica("Comunitat Valenciana").build();

        Competidor junF1 = Competidor.builder().nombre("Laia").apellidos("Bosch Martí").dni("44444401A").email("laia.bosch@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 2, 20))).genero('F').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor junF2 = Competidor.builder().nombre("Aroa").apellidos("Esteban Muñoz").dni("44444402B").email("aroa.esteban@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2008, 8, 7))).genero('F').club("Karate Zaragoza").federacionAutonomica("Aragón").build();
        Competidor junF3 = Competidor.builder().nombre("Itziar").apellidos("Mendoza Arrieta").dni("44444403C").email("itziar.mendoza@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 5, 15))).genero('F').club("Karate Vitoria").federacionAutonomica("País Vasco").build();
        Competidor junF4 = Competidor.builder().nombre("Amaia").apellidos("Garrido Urresti").dni("44444404D").email("amaia.garrido@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 10, 29))).genero('F').club("Karate Pamplona").federacionAutonomica("Comunidad Foral de Navarra").build();
        Competidor junF5 = Competidor.builder().nombre("Mireia").apellidos("Coll Segura").dni("44444405E").email("mireia.coll@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2008, 4, 3))).genero('F').club("Karate Tarragona").federacionAutonomica("Cataluña").build();
        Competidor junF6 = Competidor.builder().nombre("Naiara").apellidos("Bengoechea Landa").dni("44444406F").email("naiara.bengoechea@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 1, 22))).genero('F').club("Karate Bilbao").federacionAutonomica("País Vasco").build();

        Competidor sub21M1 = Competidor.builder().nombre("Mario").apellidos("Pena Álvarez").dni("55555501A").email("mario.pena@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2006, 4, 8))).genero('M').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor sub21M2 = Competidor.builder().nombre("Andrés").apellidos("Lara Espinosa").dni("55555502B").email("andres.lara@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2007, 9, 17))).genero('M').club("Karate Málaga").federacionAutonomica("Andalucía").build();
        Competidor sub21M3 = Competidor.builder().nombre("Guillermo").apellidos("Tejada Fuertes").dni("55555503C").email("guillermo.tejada@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2005, 12, 30))).genero('M').club("Karate Aragón").federacionAutonomica("Aragón").build();
        Competidor sub21M4 = Competidor.builder().nombre("Héctor").apellidos("Montoya Castañeda").dni("55555504D").email("hector.montoya@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2006, 7, 5))).genero('M').club("Karate Murcia").federacionAutonomica("Región de Murcia").build();
        Competidor sub21M5 = Competidor.builder().nombre("Lorenzo").apellidos("Gallego Pedrosa").dni("55555505E").email("lorenzo.gallego@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2007, 2, 19))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor sub21M6 = Competidor.builder().nombre("Nicolás").apellidos("Ibáñez Mena").dni("55555506F").email("nicolas.ibanez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2005, 10, 11))).genero('M').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor sub21M7 = Competidor.builder().nombre("Jaime").apellidos("Paredes Ojeda").dni("55555507G").email("jaime.paredes@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2006, 1, 24))).genero('M').club("Karate Galicia").federacionAutonomica("Galicia").build();
        Competidor sub21M8 = Competidor.builder().nombre("Pelayo").apellidos("Menéndez Quirós").dni("55555508H").email("pelayo.menendez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2007, 6, 13))).genero('M').club("Karate Oviedo").federacionAutonomica("Principado de Asturias").build();

        Competidor sub21F1 = Competidor.builder().nombre("Valeria").apellidos("Bravo Hidalgo").dni("66666601A").email("valeria.bravo@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2006, 3, 14))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor sub21F2 = Competidor.builder().nombre("Daniela").apellidos("Crespo Zamora").dni("66666602B").email("daniela.crespo@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2007, 8, 28))).genero('F').club("Karate Sevilla").federacionAutonomica("Andalucía").build();
        Competidor sub21F3 = Competidor.builder().nombre("Natalia").apellidos("Ríos Baena").dni("66666603C").email("natalia.rios@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2005, 11, 3))).genero('F').club("Karate Cataluña").federacionAutonomica("Cataluña").build();
        Competidor sub21F4 = Competidor.builder().nombre("Leire").apellidos("Urrutia Ibarra").dni("66666604D").email("leire.urrutia@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2006, 5, 17))).genero('F').club("Karate San Sebastián").federacionAutonomica("País Vasco").build();
        Competidor sub21F5 = Competidor.builder().nombre("Rocío").apellidos("Delgado Peña").dni("66666605E").email("rocio.delgado@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2007, 1, 6))).genero('F').club("Karate Málaga").federacionAutonomica("Andalucía").build();
        Competidor sub21F6 = Competidor.builder().nombre("Ainhoa").apellidos("Txabarri Elorza").dni("66666606F").email("ainhoa.txabarri@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2005, 7, 21))).genero('F').club("Karate Bilbao").federacionAutonomica("País Vasco").build();

        Competidor infM1 = Competidor.builder().nombre("Leo").apellidos("Muñoz Palma").dni("77777701A").email("leo.munoz@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 3, 5))).genero('M').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor infM2 = Competidor.builder().nombre("Marcos").apellidos("Rojo Calvo").dni("77777702B").email("marcos.rojo@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2014, 9, 18))).genero('M').club("Karate Sevilla").federacionAutonomica("Andalucía").build();
        Competidor infM3 = Competidor.builder().nombre("Adrián").apellidos("Lozano Rubio").dni("77777703C").email("adrian.lozano@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 6, 12))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor infM4 = Competidor.builder().nombre("Ángel").apellidos("Pereira Barros").dni("77777704D").email("angel.pereira@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2014, 12, 27))).genero('M').club("Karate Galicia").federacionAutonomica("Galicia").build();
        Competidor infM5 = Competidor.builder().nombre("Bruno").apellidos("Salas Acosta").dni("77777705E").email("bruno.salas@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 8, 4))).genero('M').club("Karate Aragón").federacionAutonomica("Aragón").build();
        Competidor infM6 = Competidor.builder().nombre("Kevin").apellidos("Ruiz Chávez").dni("77777706F").email("kevin.ruiz@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2014, 5, 20))).genero('M').club("Karate Canarias").federacionAutonomica("Canarias").build();

        Competidor infF1 = Competidor.builder().nombre("Emma").apellidos("Blanco García").dni("88888801A").email("emma.blanco@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 1, 15))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor infF2 = Competidor.builder().nombre("Olivia").apellidos("Morales Vega").dni("88888802B").email("olivia.morales@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2014, 7, 9))).genero('F').club("Karate Andalucía").federacionAutonomica("Andalucía").build();
        Competidor infF3 = Competidor.builder().nombre("Valentina").apellidos("Ríos Cano").dni("88888803C").email("valentina.rios@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 11, 23))).genero('F').club("Karate Cataluña").federacionAutonomica("Cataluña").build();
        Competidor infF4 = Competidor.builder().nombre("Sara").apellidos("Torrent Mas").dni("88888804D").email("sara.torrent@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2014, 4, 6))).genero('F').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor infF5 = Competidor.builder().nombre("Chloe").apellidos("Martín Sousa").dni("88888805E").email("chloe.martin@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 9, 30))).genero('F').club("Karate Galicia").federacionAutonomica("Galicia").build();

        Competidor alevM1 = Competidor.builder().nombre("Ian").apellidos("Durán Pedraza").dni("99999901A").email("ian.duran@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2017, 4, 2))).genero('M').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor alevM2 = Competidor.builder().nombre("Izan").apellidos("Moreira Soto").dni("99999902B").email("izan.moreira@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2016, 10, 16))).genero('M').club("Karate Andalucía").federacionAutonomica("Andalucía").build();
        Competidor alevM3 = Competidor.builder().nombre("Luca").apellidos("Ferreira Gomes").dni("99999903C").email("luca.ferreira@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2017, 7, 28))).genero('M').club("Karate Cataluña").federacionAutonomica("Cataluña").build();
        Competidor alevM4 = Competidor.builder().nombre("Dario").apellidos("Casas Moreno").dni("99999904D").email("dario.casas@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2016, 2, 11))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor alevM5 = Competidor.builder().nombre("Thiago").apellidos("Alves Costa").dni("99999905E").email("thiago.alves@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2017, 12, 5))).genero('M').club("Karate Aragón").federacionAutonomica("Aragón").build();

        Competidor alevF1 = Competidor.builder().nombre("Martina").apellidos("Iglesias Pino").dni("10101001A").email("martina.iglesias@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2017, 3, 19))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor alevF2 = Competidor.builder().nombre("Vera").apellidos("Giménez Ruiz").dni("10101002B").email("vera.gimenez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2016, 8, 7))).genero('F').club("Karate Sevilla").federacionAutonomica("Andalucía").build();
        Competidor alevF3 = Competidor.builder().nombre("Giulia").apellidos("Romano Pons").dni("10101003C").email("giulia.romano@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2017, 1, 24))).genero('F').club("Karate Cataluña").federacionAutonomica("Cataluña").build();
        Competidor alevF4 = Competidor.builder().nombre("Asia").apellidos("Delgado Leal").dni("10101004D").email("asia.delgado@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2016, 6, 13))).genero('F').club("Karate Canarias").federacionAutonomica("Canarias").build();

        Competidor juvM1 = Competidor.builder().nombre("Kai").apellidos("Santos Flores").dni("20202001A").email("kai.santos@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2013, 5, 6))).genero('M').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor juvM2 = Competidor.builder().nombre("Erik").apellidos("Palomar Cid").dni("20202002B").email("erik.palomar@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 11, 20))).genero('M').club("Karate Cataluña").federacionAutonomica("Cataluña").build();
        Competidor juvM3 = Competidor.builder().nombre("Nil").apellidos("Ferret Compte").dni("20202003C").email("nil.ferret@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2013, 8, 14))).genero('M').club("Karate Girona").federacionAutonomica("Cataluña").build();
        Competidor juvM4 = Competidor.builder().nombre("Marc").apellidos("Puig Serra").dni("20202004D").email("marc.puig@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 4, 3))).genero('M').club("Karate Baleares").federacionAutonomica("Islas Baleares").build();
        Competidor juvM5 = Competidor.builder().nombre("Noel").apellidos("Vázquez Castro").dni("20202005E").email("noel.vazquez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2013, 1, 27))).genero('M').club("Karate Galicia").federacionAutonomica("Galicia").build();
        Competidor juvM6 = Competidor.builder().nombre("Nico").apellidos("Herrero Piña").dni("20202006F").email("nico.herrero@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 9, 8))).genero('M').club("Karate Castilla").federacionAutonomica("Castilla y León").build();

        Competidor juvF1 = Competidor.builder().nombre("Inés").apellidos("Mora Bernal").dni("30303001A").email("ines.mora@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2013, 4, 10))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor juvF2 = Competidor.builder().nombre("Ayla").apellidos("Fernández Ruiz").dni("30303002B").email("ayla.fernandez@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 10, 24))).genero('F').club("Karate Andalucía").federacionAutonomica("Andalucía").build();
        Competidor juvF3 = Competidor.builder().nombre("Noa").apellidos("Rivas Llopis").dni("30303003C").email("noa.rivas@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2013, 7, 18))).genero('F').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor juvF4 = Competidor.builder().nombre("Zoe").apellidos("Andrade Lima").dni("30303004D").email("zoe.andrade@karate.es").password("password").rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 3, 5))).genero('F').club("Karate Canarias").federacionAutonomica("Canarias").build();
