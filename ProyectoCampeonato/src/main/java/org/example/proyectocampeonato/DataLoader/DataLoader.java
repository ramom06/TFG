...
public class DataLoader implements CommandLineRunner {
    ...
    private void cargarDatos() {
        ...
        //MASTER
        Categoria catMasKatM1 = Categoria.builder().nombre("Master 1 Masc. Kata").modalidad("kata").genero("M").edadMinima(35).edadMaxima(40).build();
        Categoria catMasKatM2 = Categoria.builder().nombre("Master 2 Masc. Kata").modalidad("kata").genero("M").edadMinima(41).edadMaxima(45).build();
        Categoria catMasKatM3 = Categoria.builder().nombre("Master 3 Masc. Kata").modalidad("kata").genero("M").edadMinima(46).edadMaxima(50).build();
        Categoria catMasKatM4 = Categoria.builder().nombre("Master 4 Masc. Kata").modalidad("kata").genero("M").edadMinima(51).edadMaxima(55).build();
        Categoria catMasKatM5 = Categoria.builder().nombre("Master 5 Masc. Kata").modalidad("kata").genero("M").edadMinima(56).edadMaxima(60).build();
        Categoria catMasKatM6 = Categoria.builder().nombre("Master 6 Masc. Kata").modalidad("kata").genero("M").edadMinima(61).edadMaxima(65).build();
        Categoria catMasKatM7 = Categoria.builder().nombre("Master 7 Masc. Kata").modalidad("kata").genero("M").edadMinima(66).edadMaxima(70).build();
        Categoria catMasKatM8 = Categoria.builder().nombre("Master 8 Masc. Kata").modalidad("kata").genero("M").edadMinima(71).edadMaxima(99).build();
        Categoria catMasKatF1 = Categoria.builder().nombre("Master 1 Fem. Kata").modalidad("kata").genero("F").edadMinima(35).edadMaxima(40).build();
        Categoria catMasKatF2 = Categoria.builder().nombre("Master 2 Fem. Kata").modalidad("kata").genero("F").edadMinima(41).edadMaxima(45).build();
        Categoria catMasKatF3 = Categoria.builder().nombre("Master 3 Fem. Kata").modalidad("kata").genero("F").edadMinima(46).edadMaxima(50).build();
        Categoria catMasKatF4 = Categoria.builder().nombre("Master 4 Fem. Kata").modalidad("kata").genero("F").edadMinima(51).edadMaxima(55).build();
        Categoria catMasKatF5 = Categoria.builder().nombre("Master 5 Fem. Kata").modalidad("kata").genero("F").edadMinima(56).edadMaxima(60).build();
        Categoria catMasKatF6 = Categoria.builder().nombre("Master 6 Fem. Kata").modalidad("kata").genero("F").edadMinima(61).edadMaxima(65).build();
        Categoria catMasKatF7 = Categoria.builder().nombre("Master 8 Fem. Kata").modalidad("kata").genero("F").edadMinima(71).edadMaxima(99).build();
        Categoria catMasKumM1 = Categoria.builder().nombre("Master Masc. Kumite 1").modalidad("kumite").genero("M").edadMinima(35).edadMaxima(40).pesoMaximo(75.0).build();
        Categoria catMasKumM2 = Categoria.builder().nombre("Master Masc. Kumite 2").modalidad("kumite").genero("M").edadMinima(35).edadMaxima(40).pesoMinimo(75.0).build();
        Categoria catMasKumM3 = Categoria.builder().nombre("Master Masc. Kumite 3").modalidad("kumite").genero("M").edadMinima(41).edadMaxima(50).pesoMaximo(75.0).build();
        Categoria catMasKumM4 = Categoria.builder().nombre("Master Masc. Kumite 4").modalidad("kumite").genero("M").edadMinima(41).edadMaxima(50).pesoMinimo(75.0).build();
        Categoria catMasKumM5 = Categoria.builder().nombre("Master Masc. Kumite 5").modalidad("kumite").genero("M").edadMinima(51).edadMaxima(60).pesoMaximo(75.0).build();
        Categoria catMasKumM6 = Categoria.builder().nombre("Master Masc. Kumite 6").modalidad("kumite").genero("M").edadMinima(51).edadMaxima(60).pesoMinimo(75.0).build();
        Categoria catMasKumM7 = Categoria.builder().nombre("Master Masc. Kumite 7").modalidad("kumite").genero("M").edadMinima(61).edadMaxima(99).pesoMaximo(75.0).build();
        Categoria catMasKumM8 = Categoria.builder().nombre("Master Masc. Kumite 8").modalidad("kumite").genero("M").edadMinima(61).edadMaxima(99).pesoMinimo(75.0).build();
        Categoria catMasKumF1 = Categoria.builder().nombre("Master Fem. Kumite 1").modalidad("kumite").genero("F").edadMinima(35).edadMaxima(40).build();
        Categoria catMasKumF2 = Categoria.builder().nombre("Master Fem. Kumite 2").modalidad("kumite").genero("F").edadMinima(41).edadMaxima(50).build();
        Categoria catMasKumF3 = Categoria.builder().nombre("Master Fem. Kumite 3").modalidad("kumite").genero("F").edadMinima(51).edadMaxima(99).build();

        List<Categoria> masters = new ArrayList<>(List.of(catMasKatM1, catMasKatM2, catMasKatM3, catMasKatM4, catMasKatM5, catMasKatM6, catMasKatM7, catMasKatM8, catMasKatF1, catMasKatF2, catMasKatF3, catMasKatF4, catMasKatF5, catMasKatF6, catMasKatF7, catMasKumM1, catMasKumM2, catMasKumM3, catMasKumM4, catMasKumM5, catMasKumM6, catMasKumM7, catMasKumM8, catMasKumF1, catMasKumF2, catMasKumF3));
