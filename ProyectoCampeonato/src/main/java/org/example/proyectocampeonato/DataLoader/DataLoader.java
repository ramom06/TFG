...
public class DataLoader implements CommandLineRunner {
    ...
    private void cargarDatos() {
        ...
        // CADETE
        Categoria catCadKataM = Categoria.builder().nombre("Cadete Masculino ño \"  Kata").modalidad("kata").genero("M").edadMinima(14).edadMaxima(15).build();
        ...
        Campeonato camp1 = Campeonato.builder().nombre("Campeonato de España Cadete/Junior/Sub-21 2026").fechaInicio(new Date(2026, 11, 10)).fechaFin(new Date(2026, 11, 12)).ubicacion("Pabellón Multiusos, Madrid").estado("futuro").nivel("Nacional").descripcion("Torneo clave para la clasificación al próximo campeonato de Europa").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp2 = Campeonato.builder().nombre("Campeonato de España Senior 2026").fechaInicio(new Date(2026, 2, 2)).fechaFin(new Date(2026, 2, 4)).ubicacion("Pabellón de Carranque, Málaga, Andalucía, España").estado("pasado").nivel("Nacional").descripcion("Torneo clasificatorio para el mundial").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp3 = Campeonato.builder().nombre("Campeonato de Andalucía alevin/infantil/juvenil 2026").fechaInicio(new Date(2026, 3, 1)).fechaFin(new Date(2026, 3, 1)).ubicacion("Pabellón de Deportes de Córdoba, Córdoba, Andalucía, España").estado("futuro").nivel("Provincial").descripcion("Torneo clasificatorio para el campeonato de España").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp4 = Campeonato.builder().nombre("Campeonato de Andalucía Senior 2026").fechaInicio(new Date(2026, 2, 30)).fechaFin(new Date(2026, 2, 30)).ubicacion("Pabellón de Ciudad Jardín, Málaga, Andalucía").estado("futuro").nivel("Provincial").descripcion("Torneo clasificatorio para el campeonato de España").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp5 = Campeonato.builder().nombre("Liga Iberdrola Cadete/Junior/Sub-21 J4 2026").fechaInicio(new Date(2026, 3, 8)).fechaFin(new Date(2026, 3, 8)).ubicacion("Pabellón Municipal Puerta de Santa María, 13005 Ciudad Real").estado("futuro").nivel("Nacional").descripcion("Torneo clasificatorio para el Campeonato Europeo y con recompensa de créditos").urlPortada("URL_A_DEFINIR").build();
        ...
        Campeonato camp7 = Campeonato.builder().nombre("VII Campeonato de España Master 2026").fechaInicio(new Date(2026, 4, 10)).fechaFin(new Date(2026, 4, 12)).ubicacion("La Nucía, Alicante, España").estado("futuro").nivel("Nacional").descripcion("Campeonato nacional categoría master").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp8 = Campeonato.builder().nombre("Campeonato de España Universitario 2026").fechaInicio(new Date(2026, 4, 17)).fechaFin(new Date(2026, 4, 18)).ubicacion("Granada, Andalucía, España").estado("futuro").nivel("Nacional").descripcion("Campeonato universitario nacional de karate").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp9 = Campeonato.builder().nombre("Campeonato de España Alevín/Infantil/Juvenil 2026").fechaInicio(new Date(2026, 5, 8)).fechaFin(new Date(2026, 5, 10)).ubicacion("Oviedo, Asturias, España").estado("futuro").nivel("Nacional").descripcion("Campeonato nacional categorías infantil").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp10 = Campeonato.builder().nombre("Campeonato de España Absoluto 2026").fechaInicio(new Date(2026, 3, 27)).fechaFin(new Date(2026, 3, 29)).ubicacion("Pontevedra, España").estado("futuro").nivel("Nacional").descripcion("Campeonato nacional absoluto").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp11 = Campeonato.builder().nombre("Liga Nacional Master - 1ª Ronda 2026").fechaInicio(new Date(2026, 3, 1)).fechaFin(new Date(2026, 3, 1)).ubicacion("Torrejón de Ardoz, Madrid, España").estado("futuro").nivel("Nacional").descripcion("Primera ronda liga nacional master").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp12 = Campeonato.builder().nombre("Campeonato de España Cadete/Junior/Sub-21 2026 (Final)").fechaInicio(new Date(2026, 11, 27)).fechaFin(new Date(2026, 11, 29)).ubicacion("Valencia, España").estado("futuro").nivel("Nacional").descripcion("Campeonato nacional categorías cadete junior sub21").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp13 = Campeonato.builder().nombre("Liga Nacional Masculina Absoluta/Cadete - 1ª Ronda 2026").fechaInicio(new Date(2026, 1, 17)).fechaFin(new Date(2026, 1, 17)).ubicacion("Valdepeñas, Ciudad Real, España").estado("pasado").nivel("Nacional").descripcion("Primera ronda Liga Nacional masculina absoluta y cadete").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp14 = Campeonato.builder().nombre("Liga Iberdrola Absoluta/Cadete - 1ª Ronda 2026").fechaInicio(new Date(2026, 1, 18)).fechaFin(new Date(2026, 1, 18)).ubicacion("Valdepeñas, Ciudad Real, España").estado("pasado").nivel("Nacional").descripcion("Primera ronda Liga Iberdrola femenina absoluta y cadete").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp15 = Campeonato.builder().nombre("Liga Nacional Masculina Alevín/Infantil/Juvenil - 1ª Ronda 2026").fechaInicio(new Date(2026, 2, 21)).fechaFin(new Date(2026, 2, 21)).ubicacion("Logroño, España").estado("pasado").nivel("Nacional").descripcion("Primera ronda Liga Nacional categorías base").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp16 = Campeonato.builder().nombre("Liga Iberdrola Alevín/Infantil/Juvenil - 1ª Ronda 2026").fechaInicio(new Date(2026, 2, 22)).fechaFin(new Date(2026, 2, 22)).ubicacion("Logroño, España").estado("pasado").nivel("Nacional").descripcion("Primera ronda Liga Iberdrola categorías base").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp17 = Campeonato.builder().nombre("Liga Nacional Master - 1ª Ronda 2026").fechaInicio(new Date(2026, 3, 1)).fechaFin(new Date(2026, 3, 1)).ubicacion("Torrejón de Ardoz, Madrid, España").estado("futuro").nivel("Nacional").descripcion("Primera ronda Liga Nacional master").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp18 = Campeonato.builder().nombre("Liga Nacional Junior/Sub21 - 1ª Ronda 2026").fechaInicio(new Date(2026, 3, 7)).fechaFin(new Date(2026, 3, 7)).ubicacion("Ciudad Real, España").estado("futuro").nivel("Nacional").descripcion("Primera ronda Liga Nacional junior y sub21").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp19 = Campeonato.builder().nombre("Liga Iberdrola Junior/Sub21 - 1ª Ronda 2026").fechaInicio(new Date(2026, 3, 8)).fechaFin(new Date(2026, 3, 8)).ubicacion("Ciudad Real, España").estado("futuro").nivel("Nacional").descripcion("Primera ronda Liga Iberdrola junior y sub21").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp20 = Campeonato.builder().nombre("Liga Nacional Masculina Absoluta/Cadete - 2ª Ronda 2026").fechaInicio(new Date(2026, 10, 24)).fechaFin(new Date(2026, 10, 24)).ubicacion("Elche, Alicante, España").estado("futuro").nivel("Nacional").descripcion("Segunda ronda Liga Nacional masculina absoluta y cadete").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp21 = Campeonato.builder().nombre("Liga Iberdrola Absoluta/Cadete - 2ª Ronda 2026").fechaInicio(new Date(2026, 10, 25)).fechaFin(new Date(2026, 10, 25)).ubicacion("Elche, Alicante, España").estado("futuro").nivel("Nacional").descripcion("Segunda ronda Liga Iberdrola femenina absoluta y cadete").urlPortada("URL_A_DEFINIR").build();
        Campeonato camp22 = Campeonato.builder().nombre("Liga Nacional Master - 2ª Ronda 2026").fechaInicio(new Date(2026, 11, 1)).fechaFin(new Date(2026, 11, 1)).ubicacion("Córdoba, España").estado("futuro").nivel("Nacional").descripcion("Segunda ronda Liga Nacional master").urlPortada("URL_A_DEFINIR").build();
