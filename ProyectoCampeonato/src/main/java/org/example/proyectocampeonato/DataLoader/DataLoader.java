...
public class DataLoader implements CommandLineRunner {
    ...
    private void cargarDatos() {
        ...
        Campeonato camp5 = Campeonato.builder().nombre("Campeonato de España Universitario 2026").fechaInicio(new Date(2026, 5, 27)).fechaFin(new Date(2026, 5, 30)).ubicacion("Pabellón de Ciudad Jardín, Málaga, Andalucía").estado("futuro").nivel("Nacional").descripcion("Torneo clasificatorio para el Campeonato Europeo y con recompensa de créditos").build();
        campeonatoRepository.save(camp5);

        Campeonato camp6 = Campeonato.builder().nombre("Liga Nacional Cadete/Junior/Sub-21 J4 2026").fechaInicio(new Date(2026, 3, 7)).fechaFin(new Date(2026, 3, 9)).ubicacion("Pabellón Municipal Puerta de Santa María, 13005 Ciudad Real").estado("futuro").nivel("Nacional").descripcion("Torneo clasificatorio para el Campeonato Europeo y con recompensa de créditos").build();
        ...
        Campeonato camp9 = Campeonato.builder().nombre("Campeonato de España Infantil 2026").fechaInicio(new Date(2026, 5, 8)).fechaFin(new Date(2026, 5, 10)).ubicacion("Oviedo, Asturias, España").estado("futuro").nivel("Nacional").descripcion("Campeonato nacional categorías infantil").build();
        campeonatoRepository.save(camp9);

        Campeonato camp10 = Campeonato.builder().nombre("Campeonato de España de Clubes 2026").fechaInicio(new Date(2026, 6, 19)).fechaFin(new Date(2026, 6, 21)).ubicacion("Tarragona, España").estado("futuro").nivel("Nacional").descripcion("Competición nacional por clubes").build();
        campeonatoRepository.save(camp10);

        Campeonato camp11 = Campeonato.builder().nombre("Campeonato de España Absoluto 2026").fechaInicio(new Date(2026, 3, 27)).fechaFin(new Date(2026, 3, 29)).ubicacion("Pontevedra, España").estado("futuro").nivel("Nacional").descripcion("Campeonato nacional absoluto").build();
        campeonatoRepository.save(camp11);

        Campeonato camp12 = Campeonato.builder().nombre("Liga Nacional Equipos - 1ª Ronda 2026").fechaInicio(new Date(2026, 2, 28)).fechaFin(new Date(2026, 2, 28)).ubicacion("Torrejón de Ardoz, Madrid, España").estado("pasado").nivel("Nacional").descripcion("Primera ronda liga nacional equipos").build();
        campeonatoRepository.save(camp12);

        Campeonato camp13 = Campeonato.builder().nombre("Liga Nacional Master - 1ª Ronda 2026").fechaInicio(new Date(2026, 3, 1)).fechaFin(new Date(2026, 3, 1)).ubicacion("Torrejón de Ardoz, Madrid, España").estado("futuro").nivel("Nacional").descripcion("Primera ronda liga nacional master").build();
        campeonatoRepository.save(camp13);

        Campeonato camp14 = Campeonato.builder().nombre("Campeonato de España Cadete Junior Sub-21 2026 (Final)").fechaInicio(new Date(2026, 11, 27)).fechaFin(new Date(2026, 11, 29)).ubicacion("Valencia, España").estado("futuro").nivel("Nacional").descripcion("Campeonato nacional categorías cadete junior sub21").build();
        campeonatoRepository.save(camp14);

        Campeonato camp15 = Campeonato.builder().nombre("Liga Nacional Masculina Absoluta/Cadete - 1ª Ronda 2026").fechaInicio(new Date(2026, 1, 17)).fechaFin(new Date(2026, 1, 17)).ubicacion("Valdepeñas, Ciudad Real, España").estado("pasado").nivel("Nacional").descripcion("Primera ronda Liga Nacional masculina absoluta y cadete").build();
        campeonatoRepository.save(camp15);

        Campeonato camp16 = Campeonato.builder().nombre("Liga Iberdrola Absoluta/Cadete - 1ª Ronda 2026").fechaInicio(new Date(2026, 1, 18)).fechaFin(new Date(2026, 1, 18)).ubicacion("Valdepeñas, Ciudad Real, España").estado("pasado").nivel("Nacional").descripcion("Primera ronda Liga Iberdrola femenina absoluta y cadete").build();
        campeonatoRepository.save(camp16);

        Campeonato camp17 = Campeonato.builder().nombre("Liga Nacional Masculina Alevín/Infantil/Juvenil - 1ª Ronda 2026").fechaInicio(new Date(2026, 2, 21)).fechaFin(new Date(2026, 2, 21)).ubicacion("Logroño, España").estado("pasado").nivel("Nacional").descripcion("Primera ronda Liga Nacional categorías base").build();
        campeonatoRepository.save(camp17);

        Campeonato camp18 = Campeonato.builder().nombre("Liga Iberdrola Alevín/Infantil/Juvenil - 1ª Ronda 2026").fechaInicio(new Date(2026, 2, 22)).fechaFin(new Date(2026, 2, 22)).ubicacion("Logroño, España").estado("pasado").nivel("Nacional").descripcion("Primera ronda Liga Iberdrola categorías base").build();
        campeonatoRepository.save(camp18);

        Campeonato camp19 = Campeonato.builder().nombre("Liga Nacional Equipos - 1ª Ronda 2026").fechaInicio(new Date(2026, 2, 28)).fechaFin(new Date(2026, 2, 28)).ubicacion("Torrejón de Ardoz, Madrid, España").estado("pasado").nivel("Nacional").descripcion("Primera ronda Liga Nacional por equipos").build();
        campeonatoRepository.save(camp19);

        Campeonato camp20 = Campeonato.builder().nombre("Liga Nacional Master - 1ª Ronda 2026").fechaInicio(new Date(2026, 3, 1)).fechaFin(new Date(2026, 3, 1)).ubicacion("Torrejón de Ardoz, Madrid, España").estado("futuro").nivel("Nacional").descripcion("Primera ronda Liga Nacional master").build();
        campeonatoRepository.save(camp20);

        Campeonato camp21 = Campeonato.builder().nombre("Liga Nacional Junior/Sub21 - 1ª Ronda 2026").fechaInicio(new Date(2026, 3, 7)).fechaFin(new Date(2026, 3, 7)).ubicacion("Ciudad Real, España").estado("futuro").nivel("Nacional").descripcion("Primera ronda Liga Nacional junior y sub21").build();
        campeonatoRepository.save(camp21);

        Campeonato camp22 = Campeonato.builder().nombre("Liga Iberdrola Junior/Sub21 - 1ª Ronda 2026").fechaInicio(new Date(2026, 3, 8)).fechaFin(new Date(2026, 3, 8)).ubicacion("Ciudad Real, España").estado("futuro").nivel("Nacional").descripcion("Primera ronda Liga Iberdrola junior y sub21").build();
        campeonatoRepository.save(camp22);

        Campeonato camp23 = Campeonato.builder().nombre("Liga Nacional Masculina Absoluta/Cadete - 2ª Ronda 2026").fechaInicio(new Date(2026, 10, 24)).fechaFin(new Date(2026, 10, 24)).ubicacion("Elche, Alicante, España").estado("futuro").nivel("Nacional").descripcion("Segunda ronda Liga Nacional masculina absoluta y cadete").build();
        campeonatoRepository.save(camp23);

        Campeonato camp24 = Campeonato.builder().nombre("Liga Iberdrola Absoluta/Cadete - 2ª Ronda 2026").fechaInicio(new Date(2026, 10, 25)).fechaFin(new Date(2026, 10, 25)).ubicacion("Elche, Alicante, España").estado("futuro").nivel("Nacional").descripcion("Segunda ronda Liga Iberdrola femenina absoluta y cadete").build();
        campeonatoRepository.save(camp24);

        Campeonato camp25 = Campeonato.builder().nombre("Liga Nacional Equipos - 2ª Ronda 2026").fechaInicio(new Date(2026, 10, 31)).fechaFin(new Date(2026, 10, 31)).ubicacion("Córdoba, España").estado("futuro").nivel("Nacional").descripcion("Segunda ronda Liga Nacional por equipos").build();
        campeonatoRepository.save(camp25);

        Campeonato camp26 = Campeonato.builder().nombre("Liga Nacional Master - 2ª Ronda 2026").fechaInicio(new Date(2026, 11, 1)).fechaFin(new Date(2026, 11, 1)).ubicacion("Córdoba, España").estado("futuro").nivel("Nacional").descripcion("Segunda ronda Liga Nacional master").build();
        ...
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp5, seniors));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp6, cadetes));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp6, juniors));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp6, sub21));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp7, seniors));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp8, sub21));
        ...
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp10, todasLasCategorias));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp11, seniors));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp12, todasLasCategorias));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp13, seniors));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp14, cadetes));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp14, juniors));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp14, sub21));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp15, cadetes));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp15, seniors));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp16, cadetesFemeninos));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp16, seniorsFemeninos));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp17, alevines));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp17, infantiles));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp17, juveniles));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp18, alevinesFemeninos));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp18, infantilesFemeninos));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp18, juvenilesFemeninos));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp19, todasLasCategorias));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp20, seniors));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp21, juniors));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp21, sub21));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp22, juniorsFemeninos));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp22, sub21Femeninos));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp23, cadetes));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp23, seniors));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp24, cadetesFemeninos));
        campeonato_categoriaRepository.saveAll(crearRelaciones(camp24, seniorsFemeninos));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp25, todasLasCategorias));

        campeonato_categoriaRepository.saveAll(crearRelaciones(camp26, seniors));

        // 3. CREAR COMPETIDORES
        Competidor comp1 = Competidor.builder().nombre("Juan").apellidos("Pérez Cano").dni("12345678A").fechaNacimiento(LocalDate.of(2000, 5, 20)).genero('M').club("Dojo Shoto").federacionAutonomica("Madrileña").build();
        Competidor comp2 = Competidor.builder().nombre("Alberto").apellidos("Ruiz Galiano").dni("87654321B").fechaNacimiento(LocalDate.of(1998, 11, 2)).genero('M').club("Karate Almería").federacionAutonomica("Andaluza").build();
