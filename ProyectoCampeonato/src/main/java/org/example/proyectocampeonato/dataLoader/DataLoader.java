...
// CAMPEONATOS - usando toDate() para convertir LocalDate a Date correctamente
        ...
        Competidor senM4  = Competidor.builder().nombre("Sergio").apellidos("Fernández Ruiz").dni("55667788G").email("sergio.fernandez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1997, 4, 30))).genero('M').club("Karate Santander").federacionAutonomica("Cantabria").build();
        Competidor senM5  = Competidor.builder().nombre("Miguel").apellidos("Rodríguez Blanco").dni("77889900I").email("miguel.rodriguez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1996, 12, 5))).genero('M').club("Karate Valladolid").federacionAutonomica("Castilla y León").build();
        Competidor senM6  = Competidor.builder().nombre("Javier").apellidos("Moreno Castillo").dni("99001122K").email("javier.moreno@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 2, 14))).genero('M').club("Karate Mérida").federacionAutonomica("Extremadura").build();
        Competidor senM7  = Competidor.builder().nombre("David").apellidos("Romero Iglesias").dni("10203040M").email("david.romero@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1998, 5, 3))).genero('M').club("Karate Logroño").federacionAutonomica("La Rioja").build();
        Competidor senM8  = Competidor.builder().nombre("Pablo").apellidos("Torres Herrera").dni("30405060O").email("pablo.torres@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 10, 16))).genero('M').club("Karate Murcia").federacionAutonomica("Región de Murcia").build();
        Competidor senM9  = Competidor.builder().nombre("Iñaki").apellidos("Etxebarria Zubieta").dni("50607080Q").email("inaki.etxebarria@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 6, 11))).genero('M').club("Karate Bilbao").federacionAutonomica("País Vasco").build();
        Competidor senM10 = Competidor.builder().nombre("Alejandro").apellidos("Vega Santana").dni("70809000S").email("alejandro.vega@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2003, 4, 19))).genero('M').club("Karate Melilla").federacionAutonomica("Ciudad Autónoma de Melilla").build();
        Competidor senM11 = Competidor.builder().nombre("Fernando").apellidos("Castillo Reyes").dni("11122233T").email("fernando.castillo@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1995, 8, 7))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor senM12 = Competidor.builder().nombre("Raúl").apellidos("Molina Pardo").dni("22233344U").email("raul.molina@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 1, 25))).genero('M').club("Karate Pamplona").federacionAutonomica("Comunidad Foral de Navarra").build();
        Competidor senM13 = Competidor.builder().nombre("Óscar").apellidos("Blanco Fuentes").dni("33344455V").email("oscar.blanco@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2002, 7, 13))).genero('M').club("Karate Toledo").federacionAutonomica("Castilla-La Mancha").build();
        Competidor senM14 = Competidor.builder().nombre("Marcos").apellidos("Herrera Gutiérrez").dni("44455566W").email("marcos.herrera@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1997, 3, 28))).genero('M').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor senM15 = Competidor.builder().nombre("Antonio").apellidos("Soto Medina").dni("55566677X").email("antonio.soto@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 11, 9))).genero('M').club("Karate Santiago").federacionAutonomica("Galicia").build();
        Competidor senM16 = Competidor.builder().nombre("Diego").apellidos("Cruz Navarro").dni("66677788Y").email("diego.cruz@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1994, 6, 15))).genero('M').club("Karate Oviedo").federacionAutonomica("Principado de Asturias").build();
        Competidor senM17 = Competidor.builder().nombre("Rubén").apellidos("Vidal Campos").dni("77788899Z").email("ruben.vidal@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 9, 3))).genero('M').club("Karate Palma").federacionAutonomica("Islas Baleares").build();
        Competidor senM18 = Competidor.builder().nombre("Adrián").apellidos("Aguilar Delgado").dni("88899900A").email("adrian.aguilar@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1998, 4, 22))).genero('M').club("Karate Las Palmas").federacionAutonomica("Canarias").build();
        Competidor senM19 = Competidor.builder().nombre("Álvaro").apellidos("Marín Expósito").dni("99900011B").email("alvaro.marin@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2003, 12, 1))).genero('M').club("Karate Ceuta").federacionAutonomica("Ciudad Autónoma de Ceuta").build();
        Competidor senM20 = Competidor.builder().nombre("Gonzalo").apellidos("Pascual Llorente").dni("00011122C").email("gonzalo.pascual@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1996, 7, 18))).genero('M').club("Dojo Shoto Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor senM21 = Competidor.builder().nombre("Nicolás").apellidos("Serrano Bravo").dni("11100200D").email("nicolas.serrano@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 2, 14))).genero('M').club("Karate Sevilla").federacionAutonomica("Andalucía").build();
        Competidor senM22 = Competidor.builder().nombre("Hugo").apellidos("Ramos Ibáñez").dni("22200300E").email("hugo.ramos@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 8, 30))).genero('M').club("Karate Zaragoza").federacionAutonomica("Aragón").build();
        Competidor senM23 = Competidor.builder().nombre("Víctor").apellidos("Pons Leal").dni("33300400F").email("victor.pons@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2002, 5, 11))).genero('M').club("Karate Alicante").federacionAutonomica("Comunitat Valenciana").build();
        Competidor senM24 = Competidor.builder().nombre("Eduardo").apellidos("Fuentes Cortés").dni("44400500G").email("eduardo.fuentes@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1995, 10, 27))).genero('M').club("Karate Vigo").federacionAutonomica("Galicia").build();

        Competidor senF1  = Competidor.builder().nombre("María").apellidos("García Fernández").dni("22334455D").email("maria.garcia@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 7, 8))).genero('F').club("Karate Oviedo").federacionAutonomica("Principado de Asturias").build();
        Competidor senF2  = Competidor.builder().nombre("Laura").apellidos("González Díaz").dni("44556677F").email("laura.gonzalez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 9, 12))).genero('F').club("Karate Las Palmas").federacionAutonomica("Canarias").build();
        Competidor senF3  = Competidor.builder().nombre("Ana").apellidos("Sánchez Torres").dni("66778899H").email("ana.sanchez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2003, 6, 18))).genero('F').club("Karate Toledo").federacionAutonomica("Castilla-La Mancha").build();
        Competidor senF4  = Competidor.builder().nombre("Elena").apellidos("Jiménez Moreno").dni("88990011J").email("elena.jimenez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 8, 22))).genero('F').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor senF5  = Competidor.builder().nombre("Sofía").apellidos("Álvarez Prieto").dni("00112233L").email("sofia.alvarez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2002, 11, 9))).genero('F').club("Karate Santiago").federacionAutonomica("Galicia").build();
        Competidor senF6  = Competidor.builder().nombre("Lucía").apellidos("Serrano Molina").dni("20304050N").email("lucia.serrano@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 7, 27))).genero('F').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor senF7  = Competidor.builder().nombre("Claudia").apellidos("Ramírez Ortega").dni("40506070P").email("claudia.ramirez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1997, 3, 21))).genero('F').club("Karate Pamplona").federacionAutonomica("Comunidad Foral de Navarra").build();
        Competidor senF8  = Competidor.builder().nombre("Nuria").apellidos("Campos Benítez").dni("60708090R").email("nuria.campos@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 1, 7))).genero('F').club("Karate Ceuta").federacionAutonomica("Ciudad Autónoma de Ceuta").build();
        Competidor senF9  = Competidor.builder().nombre("Patricia").apellidos("Ortiz Guerrero").dni("11200300A").email("patricia.ortiz@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1998, 4, 15))).genero('F').club("Karate Bilbao").federacionAutonomica("País Vasco").build();
        Competidor senF10 = Competidor.builder().nombre("Marta").apellidos("León Carrasco").dni("22300400B").email("marta.leon@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 12, 3))).genero('F').club("Karate Murcia").federacionAutonomica("Región de Murcia").build();
        Competidor senF11 = Competidor.builder().nombre("Cristina").apellidos("Vargas Escribano").dni("33400500C").email("cristina.vargas@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 3, 19))).genero('F').club("Karate Logroño").federacionAutonomica("La Rioja").build();
        Competidor senF12 = Competidor.builder().nombre("Isabel").apellidos("Mora Cabrera").dni("44500600D").email("isabel.mora@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1996, 9, 8))).genero('F').club("Karate Santander").federacionAutonomica("Cantabria").build();
        Competidor senF13 = Competidor.builder().nombre("Rebeca").apellidos("Pardo Montoya").dni("55600700E").email("rebeca.pardo@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2002, 6, 25))).genero('F').club("Karate Extremadura").federacionAutonomica("Extremadura").build();
        Competidor senF14 = Competidor.builder().nombre("Verónica").apellidos("Cano Iglesias").dni("66700800F").email("veronica.cano@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 11, 14))).genero('F').club("Karate Valladolid").federacionAutonomica("Castilla y León").build();
        Competidor senF15 = Competidor.builder().nombre("Beatriz").apellidos("Prieto Alonso").dni("77800900G").email("beatriz.prieto@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2003, 2, 7))).genero('F').club("Karate Aragón").federacionAutonomica("Aragón").build();
        Competidor senF16 = Competidor.builder().nombre("Sandra").apellidos("Gil Méndez").dni("88900000H").email("sandra.gil@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1997, 8, 31))).genero('F').club("Karate Palma").federacionAutonomica("Islas Baleares").build();
        Competidor senF17 = Competidor.builder().nombre("Irene").apellidos("Santos Quintero").dni("99000111I").email("irene.santos@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 5, 16))).genero('F').club("Karate Almería").federacionAutonomica("Andalucía").build();
        Competidor senF18 = Competidor.builder().nombre("Pilar").apellidos("Flores Navas").dni("10100200J").email("pilar.flores@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 1, 29))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor senF19 = Competidor.builder().nombre("Carmen").apellidos("Alvarado Peña").dni("12100300A").email("carmen.alvarado@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 3, 14))).genero('F').club("Karate Sevilla").federacionAutonomica("Andalucía").build();
        Competidor senF20 = Competidor.builder().nombre("Rocío").apellidos("Delgado Vega").dni("12100301B").email("rocio1.delgado@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1999, 8, 22))).genero('F').club("Karate Granada").federacionAutonomica("Andalucía").build();
        Competidor senF21 = Competidor.builder().nombre("Natalia").apellidos("Fuentes Ríos").dni("12100302C").email("natalia.fuentes@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2002, 11, 5))).genero('F').club("Karate Bilbao").federacionAutonomica("País Vasco").build();
        Competidor senF22 = Competidor.builder().nombre("Marta").apellidos("Crespo Solís").dni("12100303D").email("marta.crespo@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2000, 6, 30))).genero('F').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor senF23 = Competidor.builder().nombre("Alba").apellidos("Navarro Gil").dni("12100304E").email("alba.navarro@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1998, 1, 17))).genero('F').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor senF24 = Competidor.builder().nombre("Cristina").apellidos("Ortega Luna").dni("12100305F").email("cristina.ortega@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2003, 4, 9))).genero('F').club("Karate Murcia").federacionAutonomica("Región de Murcia").build();
        Competidor senF25 = Competidor.builder().nombre("Patricia").apellidos("Lara Bernal").dni("12100306G").email("patricia.lara@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2001, 9, 25))).genero('F').club("Karate Málaga").federacionAutonomica("Andalucía").build();
        Competidor senF26 = Competidor.builder().nombre("Lorena").apellidos("Vargas Pinto").dni("12100307H").email("lorena.vargas@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(1997, 12, 3))).genero('F').club("Karate Zaragoza").federacionAutonomica("Aragón").build();

        Competidor cadM1 = Competidor.builder().nombre("Mateo").apellidos("Reyes Gallardo").dni("11111101A").email("mateo.reyes@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2011, 3, 10))).genero('M').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor cadM2 = Competidor.builder().nombre("Samuel").apellidos("Vega Torres").dni("11111102B").email("samuel.vega@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 7, 22))).genero('M').club("Karate Sevilla").federacionAutonomica("Andalucía").build();
        Competidor cadM3 = Competidor.builder().nombre("Daniel").apellidos("Castro Morales").dni("11111103C").email("daniel.castro@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2011, 11, 5))).genero('M').club("Karate Zaragoza").federacionAutonomica("Aragón").build();
        Competidor cadM4 = Competidor.builder().nombre("Lucas").apellidos("Jiménez Roca").dni("11111104D").email("lucas.jimenez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 4, 18))).genero('M').club("Karate Bilbao").federacionAutonomica("País Vasco").build();
        Competidor cadM5 = Competidor.builder().nombre("Martín").apellidos("Ortega Sanz").dni("11111105E").email("martin.ortega@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 1, 30))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor cadM6 = Competidor.builder().nombre("Tomás").apellidos("Fuentes Moya").dni("11111106F").email("tomas.fuentes@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2011, 8, 14))).genero('M').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor cadM7 = Competidor.builder().nombre("Ignacio").apellidos("Blanco Rueda").dni("11111107G").email("ignacio.blanco@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 12, 3))).genero('M').club("Karate Murcia").federacionAutonomica("Región de Murcia").build();
        Competidor cadM8 = Competidor.builder().nombre("Rodrigo").apellidos("Alonso Vera").dni("11111108H").email("rodrigo.alonso@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 5, 27))).genero('M').club("Karate Valladolid").federacionAutonomica("Castilla y León").build();

        Competidor cadF1  = Competidor.builder().nombre("Carla").apellidos("Navarro Soler").dni("22222201A").email("carla.navarro@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2011, 2, 15))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor cadF2  = Competidor.builder().nombre("Andrea").apellidos("Molina Ibáñez").dni("22222202B").email("andrea.molina@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 6, 9))).genero('F').club("Karate Granada").federacionAutonomica("Andalucía").build();
        Competidor cadF3  = Competidor.builder().nombre("Paula").apellidos("Herrero Cid").dni("22222203C").email("paula.herrero@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 10, 21))).genero('F').club("Karate Pamplona").federacionAutonomica("Comunidad Foral de Navarra").build();
        Competidor cadF4  = Competidor.builder().nombre("Alba").apellidos("Pinto Serrano").dni("22222204D").email("alba.pinto@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2011, 4, 6))).genero('F').club("Karate Santander").federacionAutonomica("Cantabria").build();
        Competidor cadF5  = Competidor.builder().nombre("Nora").apellidos("Medina Rubio").dni("22222205E").email("nora.medina@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 9, 28))).genero('F').club("Karate Logroño").federacionAutonomica("La Rioja").build();
        Competidor cadF6  = Competidor.builder().nombre("Julia").apellidos("Varela Peña").dni("22222206F").email("julia.varela@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 3, 17))).genero('F').club("Karate Galicia").federacionAutonomica("Galicia").build();
        Competidor cadF7  = Competidor.builder().nombre("Elena").apellidos("Vidal Soto").dni("22222207G").email("elena.vidal@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2011, 5, 3))).genero('F').club("Karate Alicante").federacionAutonomica("Comunitat Valenciana").build();
        Competidor cadF8  = Competidor.builder().nombre("Nora").apellidos("Campos Ruiz").dni("22222208H").email("nora.campos@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 9, 17))).genero('F').club("Karate Málaga").federacionAutonomica("Andalucía").build();
        Competidor cadF9  = Competidor.builder().nombre("Sofía").apellidos("Ibáñez Crespo").dni("22222209I").email("sofia.ibanez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 2, 28))).genero('F').club("Karate Murcia").federacionAutonomica("Región de Murcia").build();
        Competidor cadF10 = Competidor.builder().nombre("Claudia").apellidos("Serrano Moya").dni("22222210J").email("claudia.serrano@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2011, 7, 11))).genero('F').club("Karate Córdoba").federacionAutonomica("Andalucía").build();
        Competidor cadF11 = Competidor.builder().nombre("Gabriela").apellidos("Mora Peña").dni("22222211K").email("gabriela.mora@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 11, 4))).genero('F').club("Karate Zaragoza").federacionAutonomica("Aragón").build();
        Competidor cadF12 = Competidor.builder().nombre("Lucía").apellidos("Romero Lago").dni("22222212L").email("lucia.romero@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 4, 19))).genero('F').club("Karate Vigo").federacionAutonomica("Galicia").build();

        Competidor junM1 = Competidor.builder().nombre("Álex").apellidos("Romero Cuesta").dni("33333301A").email("alex.romero@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 5, 12))).genero('M').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor junM2 = Competidor.builder().nombre("Iker").apellidos("Zubieta Larrea").dni("33333302B").email("iker.zubieta@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2008, 11, 25))).genero('M').club("Karate San Sebastián").federacionAutonomica("País Vasco").build();
        Competidor junM3 = Competidor.builder().nombre("Unai").apellidos("Arrizabalaga Olaiz").dni("33333303C").email("unai.arrizabalaga@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 3, 8))).genero('M').club("Karate Bilbao").federacionAutonomica("País Vasco").build();
        Competidor junM4 = Competidor.builder().nombre("Joel").apellidos("Giménez Puig").dni("33333304D").email("joel.gimenez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 1, 14))).genero('M').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor junM5 = Competidor.builder().nombre("Pol").apellidos("Soler Massana").dni("33333305E").email("pol.soler@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 7, 30))).genero('M').club("Karate Lleida").federacionAutonomica("Cataluña").build();
        Competidor junM6 = Competidor.builder().nombre("Enrique").apellidos("Pascual Delgado").dni("33333306F").email("enrique.pascual@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2008, 9, 19))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor junM7 = Competidor.builder().nombre("Borja").apellidos("Cabrera Núñez").dni("33333307G").email("borja.cabrera@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 4, 3))).genero('M').club("Karate Tenerife").federacionAutonomica("Canarias").build();
        Competidor junM8 = Competidor.builder().nombre("Jonás").apellidos("Ferrer Llorens").dni("33333308H").email("jonas.ferrer@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 12, 11))).genero('M').club("Karate Alicante").federacionAutonomica("Comunitat Valenciana").build();

        Competidor junF1 = Competidor.builder().nombre("Laia").apellidos("Bosch Martí").dni("44444401A").email("laia.bosch@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 2, 20))).genero('F').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor junF2 = Competidor.builder().nombre("Aroa").apellidos("Esteban Muñoz").dni("44444402B").email("aroa.esteban@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2008, 8, 7))).genero('F').club("Karate Zaragoza").federacionAutonomica("Aragón").build();
        Competidor junF3 = Competidor.builder().nombre("Itziar").apellidos("Mendoza Arrieta").dni("44444403C").email("itziar.mendoza@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 5, 15))).genero('F').club("Karate Vitoria").federacionAutonomica("País Vasco").build();
        Competidor junF4 = Competidor.builder().nombre("Amaia").apellidos("Garrido Urresti").dni("44444404D").email("amaia.garrido@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2009, 10, 29))).genero('F').club("Karate Pamplona").federacionAutonomica("Comunidad Foral de Navarra").build();
        Competidor junF5 = Competidor.builder().nombre("Mireia").apellidos("Coll Segura").dni("44444405E").email("mireia.coll@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2008, 4, 3))).genero('F').club("Karate Tarragona").federacionAutonomica("Cataluña").build();
        Competidor junF6 = Competidor.builder().nombre("Naiara").apellidos("Bengoechea Landa").dni("44444406F").email("naiara.bengoechea@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2010, 1, 22))).genero('F').club("Karate Bilbao").federacionAutonomica("País Vasco").build();

        Competidor sub21M1 = Competidor.builder().nombre("Mario").apellidos("Pena Álvarez").dni("55555501A").email("mario.pena@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2006, 4, 8))).genero('M').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor sub21M2 = Competidor.builder().nombre("Andrés").apellidos("Lara Espinosa").dni("55555502B").email("andres.lara@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2007, 9, 17))).genero('M').club("Karate Málaga").federacionAutonomica("Andalucía").build();
        Competidor sub21M3 = Competidor.builder().nombre("Guillermo").apellidos("Tejada Fuertes").dni("55555503C").email("guillermo.tejada@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2005, 12, 30))).genero('M').club("Karate Aragón").federacionAutonomica("Aragón").build();
        Competidor sub21M4 = Competidor.builder().nombre("Héctor").apellidos("Montoya Castañeda").dni("55555504D").email("hector.montoya@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2006, 7, 5))).genero('M').club("Karate Murcia").federacionAutonomica("Región de Murcia").build();
        Competidor sub21M5 = Competidor.builder().nombre("Lorenzo").apellidos("Gallego Pedrosa").dni("55555505E").email("lorenzo.gallego@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2007, 2, 19))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor sub21M6 = Competidor.builder().nombre("Nicolás").apellidos("Ibáñez Mena").dni("55555506F").email("nicolas.ibanez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2005, 10, 11))).genero('M').club("Karate Barcelona").federacionAutonomica("Cataluña").build();
        Competidor sub21M7 = Competidor.builder().nombre("Jaime").apellidos("Paredes Ojeda").dni("55555507G").email("jaime.paredes@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2006, 1, 24))).genero('M').club("Karate Galicia").federacionAutonomica("Galicia").build();
        Competidor sub21M8 = Competidor.builder().nombre("Pelayo").apellidos("Menéndez Quirós").dni("55555508H").email("pelayo.menendez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2007, 6, 13))).genero('M').club("Karate Oviedo").federacionAutonomica("Principado de Asturias").build();

        Competidor sub21F1 = Competidor.builder().nombre("Valeria").apellidos("Bravo Hidalgo").dni("66666601A").email("valeria.bravo@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2006, 3, 14))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor sub21F2 = Competidor.builder().nombre("Daniela").apellidos("Crespo Zamora").dni("66666602B").email("daniela.crespo@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2007, 8, 28))).genero('F').club("Karate Sevilla").federacionAutonomica("Andalucía").build();
        Competidor sub21F3 = Competidor.builder().nombre("Natalia").apellidos("Ríos Baena").dni("66666603C").email("natalia.rios@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2005, 11, 3))).genero('F').club("Karate Cataluña").federacionAutonomica("Cataluña").build();
        Competidor sub21F4 = Competidor.builder().nombre("Leire").apellidos("Urrutia Ibarra").dni("66666604D").email("leire.urrutia@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2006, 5, 17))).genero('F').club("Karate San Sebastián").federacionAutonomica("País Vasco").build();
        Competidor sub21F5 = Competidor.builder().nombre("Rocío").apellidos("Delgado Peña").dni("66666605E").email("rocio.delgado@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2007, 1, 6))).genero('F').club("Karate Málaga").federacionAutonomica("Andalucía").build();
        Competidor sub21F6 = Competidor.builder().nombre("Ainhoa").apellidos("Txabarri Elorza").dni("66666606F").email("ainhoa.txabarri@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2005, 7, 21))).genero('F').club("Karate Bilbao").federacionAutonomica("País Vasco").build();

        Competidor infM1 = Competidor.builder().nombre("Leo").apellidos("Muñoz Palma").dni("77777701A").email("leo.munoz@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 3, 5))).genero('M').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor infM2 = Competidor.builder().nombre("Marcos").apellidos("Rojo Calvo").dni("77777702B").email("marcos.rojo@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2014, 9, 18))).genero('M').club("Karate Sevilla").federacionAutonomica("Andalucía").build();
        Competidor infM3 = Competidor.builder().nombre("Adrián").apellidos("Lozano Rubio").dni("77777703C").email("adrian.lozano@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 6, 12))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor infM4 = Competidor.builder().nombre("Ángel").apellidos("Pereira Barros").dni("77777704D").email("angel.pereira@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2014, 12, 27))).genero('M').club("Karate Galicia").federacionAutonomica("Galicia").build();
        Competidor infM5 = Competidor.builder().nombre("Bruno").apellidos("Salas Acosta").dni("77777705E").email("bruno.salas@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 8, 4))).genero('M').club("Karate Aragón").federacionAutonomica("Aragón").build();
        Competidor infM6 = Competidor.builder().nombre("Kevin").apellidos("Ruiz Chávez").dni("77777706F").email("kevin.ruiz@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2014, 5, 20))).genero('M').club("Karate Canarias").federacionAutonomica("Canarias").build();

        Competidor infF1 = Competidor.builder().nombre("Emma").apellidos("Blanco García").dni("88888801A").email("emma.blanco@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 1, 15))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor infF2 = Competidor.builder().nombre("Olivia").apellidos("Morales Vega").dni("88888802B").email("olivia.morales@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2014, 7, 9))).genero('F').club("Karate Andalucía").federacionAutonomica("Andalucía").build();
        Competidor infF3 = Competidor.builder().nombre("Valentina").apellidos("Ríos Cano").dni("88888803C").email("valentina.rios@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 11, 23))).genero('F').club("Karate Cataluña").federacionAutonomica("Cataluña").build();
        Competidor infF4 = Competidor.builder().nombre("Sara").apellidos("Torrent Mas").dni("88888804D").email("sara.torrent@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2014, 4, 6))).genero('F').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor infF5 = Competidor.builder().nombre("Chloe").apellidos("Martín Sousa").dni("88888805E").email("chloe.martin@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2015, 9, 30))).genero('F').club("Karate Galicia").federacionAutonomica("Galicia").build();

        Competidor alevM1 = Competidor.builder().nombre("Ian").apellidos("Durán Pedraza").dni("99999901A").email("ian.duran@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2017, 4, 2))).genero('M').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor alevM2 = Competidor.builder().nombre("Izan").apellidos("Moreira Soto").dni("99999902B").email("izan.moreira@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2016, 10, 16))).genero('M').club("Karate Andalucía").federacionAutonomica("Andalucía").build();
        Competidor alevM3 = Competidor.builder().nombre("Luca").apellidos("Ferreira Gomes").dni("99999903C").email("luca.ferreira@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2017, 7, 28))).genero('M').club("Karate Cataluña").federacionAutonomica("Cataluña").build();
        Competidor alevM4 = Competidor.builder().nombre("Dario").apellidos("Casas Moreno").dni("99999904D").email("dario.casas@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2016, 2, 11))).genero('M').club("Karate Valencia").federacionAutonomica("Comunitat Valenciana").build();
        Competidor alevM5 = Competidor.builder().nombre("Thiago").apellidos("Alves Costa").dni("99999905E").email("thiago.alves@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2017, 12, 5))).genero('M').club("Karate Aragón").federacionAutonomica("Aragón").build();

        Competidor alevF1 = Competidor.builder().nombre("Martina").apellidos("Iglesias Pino").dni("10101001A").email("martina.iglesias@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2017, 3, 19))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor alevF2 = Competidor.builder().nombre("Vera").apellidos("Giménez Ruiz").dni("10101002B").email("vera.gimenez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2016, 8, 7))).genero('F').club("Karate Sevilla").federacionAutonomica("Andalucía").build();
        Competidor alevF3 = Competidor.builder().nombre("Giulia").apellidos("Romano Pons").dni("10101003C").email("giulia.romano@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2017, 1, 24))).genero('F').club("Karate Cataluña").federacionAutonomica("Cataluña").build();
        Competidor alevF4 = Competidor.builder().nombre("Asia").apellidos("Delgado Leal").dni("10101004D").email("asia.delgado@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2016, 6, 13))).genero('F').club("Karate Canarias").federacionAutonomica("Canarias").build();

        Competidor juvM1 = Competidor.builder().nombre("Kai").apellidos("Santos Flores").dni("20202001A").email("kai.santos@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2013, 5, 6))).genero('M').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor juvM2 = Competidor.builder().nombre("Erik").apellidos("Palomar Cid").dni("20202002B").email("erik.palomar@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 11, 20))).genero('M').club("Karate Cataluña").federacionAutonomica("Cataluña").build();
        Competidor juvM3 = Competidor.builder().nombre("Nil").apellidos("Ferret Compte").dni("20202003C").email("nil.ferret@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2013, 8, 14))).genero('M').club("Karate Girona").federacionAutonomica("Cataluña").build();
        Competidor juvM4 = Competidor.builder().nombre("Marc").apellidos("Puig Serra").dni("20202004D").email("marc.puig@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 4, 3))).genero('M').club("Karate Baleares").federacionAutonomica("Islas Baleares").build();
        Competidor juvM5 = Competidor.builder().nombre("Noel").apellidos("Vázquez Castro").dni("20202005E").email("noel.vazquez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2013, 1, 27))).genero('M').club("Karate Galicia").federacionAutonomica("Galicia").build();
        Competidor juvM6 = Competidor.builder().nombre("Nico").apellidos("Herrero Piña").dni("20202006F").email("nico.herrero@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 9, 8))).genero('M').club("Karate Castilla").federacionAutonomica("Castilla y León").build();

        Competidor juvF1 = Competidor.builder().nombre("Inés").apellidos("Mora Bernal").dni("30303001A").email("ines.mora@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2013, 4, 10))).genero('F').club("Karate Madrid").federacionAutonomica("Comunidad de Madrid").build();
        Competidor juvF2 = Competidor.builder().nombre("Ayla").apellidos("Fernández Ruiz").dni("30303002B").email("ayla.fernandez@karate.es").password(encodedPassword).rol(Usuario.Rol.COMPETIDOR).fechaNacimiento(toDate(LocalDate.of(2012, 10, 24))).genero('F').club("Karate Andalucía").federacionAutonomica("Andalucía").build();
...
// Cadete Femenino Kumite <54kg
        ...
        combates.addAll(generarRonda1(camp1, catCadKataM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp1.getIdCampeonato(), catCadKataM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp1, catCadKataF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp1.getIdCampeonato(), catCadKataF.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp1, catJunKatM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp1.getIdCampeonato(), catJunKatM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp1, catJunKatF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp1.getIdCampeonato(), catJunKatF.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp1, catSub21KatM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp1.getIdCampeonato(), catSub21KatM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp1, catSub21KatF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp1.getIdCampeonato(), catSub21KatF.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp2, catSenKatM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp2.getIdCampeonato(), catSenKatM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp2, catSenKatF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp2.getIdCampeonato(), catSenKatF.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp3, catAlevKataM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp3.getIdCampeonato(), catAlevKataM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp3, catAlevKataF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp3.getIdCampeonato(), catAlevKataF.getIdCategoria())).orElseThrow(),
                List.of(alevF1, alevF2, alevF3, alevF4), 2, java.time.LocalTime.of(9, 0), 15));

        combates.addAll(generarRonda1(camp3, catInfKataM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp3.getIdCampeonato(), catInfKataM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp3, catInfKataF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp3.getIdCampeonato(), catInfKataF.getIdCategoria())).orElseThrow(),
                List.of(infF1, infF2, infF3, infF4, infF5), 4, java.time.LocalTime.of(9, 0), 15));

        combates.addAll(generarRonda1(camp3, catJuvKataM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp3.getIdCampeonato(), catJuvKataM.getIdCategoria())).orElseThrow(),
                List.of(juvM1, juvM2, juvM3, juvM4, juvM5), 5, java.time.LocalTime.of(9, 0), 15));

        combates.addAll(generarRonda1(camp3, catJuvKataF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp3.getIdCampeonato(), catJuvKataF.getIdCategoria())).orElseThrow(),
                List.of(juvF1, juvF2, juvF3, juvF4, juvF5), 6, java.time.LocalTime.of(9, 0), 15));

        // ── CAMP4: Campeonato Andalucía Senior ────────────────────────────────
        combates.addAll(generarRonda1(camp4, catSenKatM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp4.getIdCampeonato(), catSenKatM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp4, catSenKatF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp4.getIdCampeonato(), catSenKatF.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp5, catSub21KatF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp5.getIdCampeonato(), catSub21KatF.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp6, catSub21KatM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp6.getIdCampeonato(), catSub21KatM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp9, catInfKataM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp9.getIdCampeonato(), catInfKataM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp9, catInfKataF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp9.getIdCampeonato(), catInfKataF.getIdCategoria())).orElseThrow(),
                List.of(infF1, infF2, infF3, infF4, infF5), 2, java.time.LocalTime.of(9, 0), 15));

        // ── CAMP10: Campeonato España Absoluto ────────────────────────────────
        combates.addAll(generarRonda1(camp10, catSenKatM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp10.getIdCampeonato(), catSenKatM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp10, catSenKatF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp10.getIdCampeonato(), catSenKatF.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp15, catAlevKataM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp15.getIdCampeonato(), catAlevKataM.getIdCategoria())).orElseThrow(),
                List.of(alevM1, alevM2, alevM3, alevM4, alevM5), 1, java.time.LocalTime.of(9, 0), 15));

        combates.addAll(generarRonda1(camp15, catInfKataM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp15.getIdCampeonato(), catInfKataM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp15, catJuvKataM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp15.getIdCampeonato(), catJuvKataM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp16, catAlevKataF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp16.getIdCampeonato(), catAlevKataF.getIdCategoria())).orElseThrow(),
                List.of(alevF1, alevF2, alevF3, alevF4), 1, java.time.LocalTime.of(9, 0), 15));

        combates.addAll(generarRonda1(camp16, catInfKataF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp16.getIdCampeonato(), catInfKataF.getIdCategoria())).orElseThrow(),
                List.of(infF1, infF2, infF3, infF4, infF5), 2, java.time.LocalTime.of(9, 0), 15));

        combates.addAll(generarRonda1(camp16, catJuvKataF,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp16.getIdCampeonato(), catJuvKataF.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp17, catMasKatM1,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp17.getIdCampeonato(), catMasKatM1.getIdCategoria())).orElseThrow(),
                List.of(senM1, senM2, senM3, senM4), 1, java.time.LocalTime.of(9, 0), 15));

        combates.addAll(generarRonda1(camp17, catMasKatF1,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp17.getIdCampeonato(), catMasKatF1.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp18, catJunKatM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp18.getIdCampeonato(), catJunKatM.getIdCategoria())).orElseThrow(),
        ...
        combates.addAll(generarRonda1(camp18, catSub21KatM,
                campeonato_categoriaRepository.findById(new Campeonato_Categoria_Id(camp18.getIdCampeonato(), catSub21KatM.getIdCategoria())).orElseThrow(),
